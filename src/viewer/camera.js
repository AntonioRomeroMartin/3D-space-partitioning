...
import { Controls, Quaternion, Vector3 } from "three";
...
// ─── FlyControls (based on Three.js source, AZERTY layout) ───────────────────
...
// ─── Key handlers — AZERTY: Z/S = voor/achter, Q/D = links/rechts, A/E = op/neer
...
function onKeyDown(event) {
  ...
  switch (event.code) {
    ...
    case "KeyQ": this._moveState.up   = 1; break;
    case "KeyE": this._moveState.down = 1; break;
    ...
    case "KeyZ": this._moveState.rollLeft  = 1; break;
    case "KeyC": this._moveState.rollRight = 1; break;
...
function onKeyUp(event) {
  ...
  switch (event.code) {
    ...
    case "KeyQ": this._moveState.up   = 0; break;
    case "KeyE": this._moveState.down = 0; break;
    ...
    case "KeyZ": this._moveState.rollLeft  = 0; break;
    case "KeyC": this._moveState.rollRight = 0; break;
